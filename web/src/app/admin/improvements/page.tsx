...
export default function Improvements(){
  ...
  return <main className="mx-auto min-h-screen max-w-5xl bg-zinc-50 p-6 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50">
    ...
    <section className={`mb-8 rounded-xl border-2 p-5 ${requiredActions.length||retryActions.length||evidenceActions.length?"border-amber-500 bg-amber-50 text-amber-950":"border-emerald-300 bg-emerald-50 text-emerald-950"}`}>
      <h2 className="text-xl font-semibold">Required human actions</h2>
      <p className="mt-1 text-sm">{requiredActions.length||retryActions.length||evidenceActions.length?"These governed actions are waiting. Nothing below is silently approved, published, activated, or promoted.":"No candidate-builder approval, evidence, or retry action is currently waiting."}</p>
